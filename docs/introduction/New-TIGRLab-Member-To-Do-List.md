...
- [ ] **Read through the Lab Manual**: Our lab manual can be [found here](https://docs.google.com/document/d/1jRI-8jB2alJVqDepFKpPQOjBeTUFhu_o/edit) and details all of our lab's policies and expectations. Feel free, also, to suggest edits or changes and feel free to discuss any part of it with us if you have questions or comments.
- [ ] **Get a lab account:** Talk to an admin (Dawn) and get a lab account set up so you can use all of our workstations.
- [ ] **Request access to the lab mailing list:** ask a lab employee (e.g. Dawn) to add you to the lab's mailing list. We use this mailing list to send important lab notices and to share interesting papers, upcoming deadlines, etc. Everyone in the lab should have access.
- [ ] **Create a [GitHub account](http://github.com) (if you don't already have one) and send your username to tigrlab@camh.ca or a lab employee.** We use this account to add you to our GitHub organization, which then gives you access to our [private documentation](https://github.com/TIGRLab/admin/wiki), our [issue tracker](#issue-tracker) (where you can request help and report problems), and to our QC dashboard. It also gives you access to any private repositories we might have and allows you to add your own repositories if you work on any code for the lab.
...
- [ ] **Browse through the rest of the 'introduction' section of this wiki!** Not all pages on the wiki are relevant to everyone, or relevant right when you start, but there is a lot scattered throughout its pages that will help acclimate you to the lab. Once you have your GitHub account, you may add/edit pages (please do!). Also please let us know if you see room for improvement in our wiki as you read through it.
...
| Dawn | Apr 21, 2026 | Updated contents, reviewed for relevance. |
<!-- sign-off-sheet:end -->
