...
- `module spider some_software_name`: You can use this command to get a list of available modules that offer a specific piece of software, if any exist.
...
| Dawn | Apr 21, 2026 | Updated contents, reviewed for accuracy. |
<!-- sign-off-sheet:end -->